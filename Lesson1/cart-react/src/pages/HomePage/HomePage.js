...
const HomePage = () => {
    ...
    const onViewProductDetail = (id) => {
      console.log("id" ,id);
      const selectedPrduct = products.find((product) => product.id === id);
      setSelectedProduct(selectedPrduct)
    }
  
    return (
      <div className="container">
        <ProductList  products={products} onViewProductDetail={onViewProductDetail}/>
